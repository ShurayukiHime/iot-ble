...
The main objective of the attack, is to connect to the device, extract its informations and features, as well as the MAC address, and create a dummy device of it, copy of the original. Then wait for the connection and forward the messages to the destination.
